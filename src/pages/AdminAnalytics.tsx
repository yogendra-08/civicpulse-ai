...
export function AdminAnalytics() {
  ...
  if (!complaints) return <DashboardLayout><LoadingOverlay label="Loading analytics..." /></DashboardLayout>;
    ...
    <DashboardLayout>
      ...
      <div className="mb-6 animate-fade-in">
        <h1 className="text-2xl font-extrabold text-navy-900 flex items-center gap-2">
          <BarChart3 className="h-7 w-7 text-gov-600" /> Analytics Dashboard
        </h1>
        <p className="text-slate-500 mt-1">Comprehensive insights into complaint patterns, resolution trends, and department performance.</p>
      </div>
      ...
      <div className="grid lg:grid-cols-2 gap-6 mb-6">
        {/* Monthly trend */}
        <ChartCard title="Monthly Complaint Trends" subtitle="Complaints filed vs resolved over 6 months" icon={TrendingUp}>
          <ResponsiveContainer width="100%" height={280}>
            <AreaChart data={monthlyTrend} margin={{ top: 5, right: 10, left: -10, bottom: 0 }}>
              ...
              <Area type="monotone" dataKey="complaints" stroke="#3478ff" strokeWidth={2} fill="url(#gComplaints)" name="Complaints" />
              <Area type="monotone" dataKey="resolved" stroke="#10b981" strokeWidth={2} fill="url(#gResolved)" name="Resolved" />
            </AreaChart>
          </ResponsiveContainer>
        </ChartCard>

        {/* Category distribution */}
        <ChartCard title="Complaint Category Distribution" subtitle="Breakdown by AI-detected category" icon={PieIcon}>
          <ResponsiveContainer width="100%" height={280}>
            <PieChart>
              <Pie
                data={categoryData}
        ...
        {/* Resolution trend */}
        <ChartCard title="Resolution Trends" subtitle="Weekly status breakdown" icon={TrendingUp}>
          <ResponsiveContainer width="100%" height={280}>
            <LineChart data={resolutionTrend} margin={{ top: 5, right: 10, left: -10, bottom: 0 }}>
              ...
              <Line type="monotone" dataKey="inProgress" stroke="#ff9b32" strokeWidth={2} dot={{ r: 3 }} name="In Progress" />
        ...
        {/* Severity breakdown */}
        <ChartCard title="Severity Breakdown" subtitle="Complaints by severity level" icon={AlertTriangle}>
          <ResponsiveContainer width="100%" height={280}>
      ...
      <div className="grid lg:grid-cols-2 gap-6">
        ...
        <ChartCard title="Department Performance" subtitle="Total vs resolved complaints by department" icon={Building}>
          <ResponsiveContainer width="100%" height={280}>
            <BarChart data={deptData} margin={{ top: 5, right: 10, left: -10, bottom: 0 }}>
              ...
              <Tooltip />
              <Legend wrapperStyle={{ fontSize: 12 }} />
              <Bar dataKey="total" fill="#3478ff" radius={[4, 4, 0, 0]} name="Total" />
        ...
        {/* Top problem wards */}
        <ChartCard title="Top Problem Wards" subtitle="Wards with most complaints" icon={MapPin}>
          <ResponsiveContainer width="100%" height={280}>
            <BarChart data={wardData} layout="vertical" margin={{ top: 5, right: 20, left: 10, bottom: 0 }}>
              ...
              <Tooltip />
              <Bar dataKey="count" fill="#1c5af5" radius={[0, 4, 4, 0]} name="Complaints" />
            </BarChart>
          </ResponsiveContainer>
        </ChartCard>
      </div>
